...
<script src="//cdnjs.cloudflare.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script>
    ...
    <body>
     ...
     <form id="login-form" class="form" action="crear" >
       <div class="form-group">
              <input type="submit" name="crear" class="btn btn-info btn-md" value="Agregar nuevo">
         </div>
         </form>
       <table border="1" >
		<tr>
		...
		<tr>
            ...
            <td><?php echo $mostrar['tipo_moneda'] ?></td>
